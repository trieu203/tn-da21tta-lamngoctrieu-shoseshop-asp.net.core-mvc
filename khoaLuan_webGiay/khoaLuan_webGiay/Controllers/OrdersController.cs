...
namespace khoaLuan_webGiay.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderId,UserId,OrderDate,TotalAmount,OrderStatus,ShippingAddress,Email,PhoneNumber,IsConfirmed")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,UserId,OrderDate,TotalAmount,OrderStatus,ShippingAddress,Email,PhoneNumber,IsConfirmed")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
