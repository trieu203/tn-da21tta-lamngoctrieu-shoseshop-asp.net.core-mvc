...
namespace khoaLuan_webGiay.Controllers
{
    public class CartItemsController : Controller
    {
        ...
        public CartItemsController(KhoaLuanContext context)
        {
            _context = context;
        }
        ...
        {
            var khoaLuanContext = _context.CartItems.Include(c => c.Cart).Include(c => c.Product);
        ...
        public async Task<IActionResult> Create([Bind("CartItemId,CartId,ProductId,Size,Quantity,PriceAtTime,ImageUrl,ProductName")] CartItem cartItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CartItemId,CartId,ProductId,Size,Quantity,PriceAtTime,ImageUrl,ProductName")] CartItem cartItem)
        {
